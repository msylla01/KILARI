...
#    service = models.ForeignKey(Service, on_delete=models.CASCADE,related_name='ser',blank=True)
#    platform = models.ForeignKey(Platform, on_delete=models.CASCADE,related_name='plat',blank=True)
#    pays = models.ForeignKey(Pays, on_delete=models.CASCADE,related_name='pays',blank=True)
